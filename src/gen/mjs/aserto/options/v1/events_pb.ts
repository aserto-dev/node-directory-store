 ...
 */
export const file_aserto_options_v1_events: GenFile = /*@__PURE__*/
 ...
 */
export const event: GenExtension<MessageOptions, Event> = /*@__PURE__*/
  extDesc(file_aserto_options_v1_events, 0);

/**
 * @generated from extension: string tag = 50095;
 */
export const tag: GenExtension<FieldOptions, string> = /*@__PURE__*/
